			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Reservation</h2>
						<p>Book Your Table Within Minutes</p>
					</div>
				</div>
			</div>
			<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="col-md-12">
										<div class="form-group">
											<input placeholder="Select Date" id="input_date" class="datepicker picker__input form-control" name="date" type="text" value="" equired data-error="Please enter Date">
											<div class="help-block with-errors"></div>
										</div>                                 
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input placeholder="Select Timing" id="input_time" class="time form-control picker__input" required data-error="Please enter time">
											<div class="help-block with-errors"></div>
										</div>                                 
									</div>
									<div class="col-md-12">
